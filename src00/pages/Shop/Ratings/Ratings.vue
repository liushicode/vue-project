<template>
  <div class="ratings">
    <div class="ratings-content">
      ...
      <div>
        <RatingSelect :onlyText="onlyText" :selectType="selectType" />
      </div>
        ...
        <ul>
          <li class="rating-item" v-for="(rating,index) in filterRatings" :key="index">
            ...
            <div class="content">
              ...
              <div class="time">{{rating.rateTime|datafmt('YYYY-MM-DD HH:mm:ss')}}</div>
            </div>
          </li>
        </ul>
      </div>
