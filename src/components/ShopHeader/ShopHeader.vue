    ...
    <div class="shop-content" @click="isShowBulletin=!isShowBulletin">
      ...
      <div class="header-content">
        ...
        <div class="shop-message">
          ...
          <span class="shop-message-detail">距离距离{{info.distance}}</span>
        </div>
        <p class="shop-notice">{{info.bulletin}}</p>
      </div>
    </div>
    <div class="shop-header-discounts" @click="isShowSupport=!isShowSupport">
...
export default {
  ...
  data () {
    return {
      isShowBulletin: false,// 是否显示公告信息
      isShowSupport: false,// 是否显示优惠信息
